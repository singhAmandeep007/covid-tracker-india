   ...
   return (
      <>
         ...
         <div className="ui top right attached label">
            Last Updated:{' '}
            <div className="detail">{selectedStateInfo.lastupdatedtime}</div>
         </div>
               ...
               <Table.Header>
                  <Table.Row>
                     ...
                     <Table.HeaderCell
                        ...
                        onClick={() =>
                           dispatch({ type: 'CHANGE_SORT', column: 'active' })
                        }
                        style={{
                     ...
                     <Table.HeaderCell
                        ...
                        onClick={() =>
                           dispatch({ type: 'CHANGE_SORT', column: 'deaths' })
                        }
                        style={{
                        ...
                        return (
                           ...
                           >
                              ...
                              <Table.Cell
                                 style={{
                                    backgroundColor:
                                       colorPalette.confirmed.shadeLight,
                                 }}
                              >
                                 {confirmed}
                              </Table.Cell>
                              <Table.Cell
                                 style={{
                                    backgroundColor:
                                       colorPalette.active.shadeLight,
                                 }}
                              >
                                 {active}
                              </Table.Cell>
                              <Table.Cell
                                 style={{
                                    backgroundColor:
                                       colorPalette.recovered.shadeLight,
                                 }}
                              >
                                 {recovered}
                              </Table.Cell>
                              <Table.Cell
                                 style={{
                                    backgroundColor:
                                       colorPalette.deaths.shadeLight,
                                 }}
                              >
                                 {deaths}
                              </Table.Cell>
